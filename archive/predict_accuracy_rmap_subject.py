# For each patient load the r map whcih was generated without the data from the patient
# Then compute the distance of the map to each channel from the patient
# Correlate the distance to the r map with the accuracy of each channel
...
for sub in subjects:
    ...
    # Load the rmap
    r_map = loadmat(f"../data_epochs/metadata/r_maps_2/Subject_9_func_seed_AvgR_Fz.mat")["corr"]
